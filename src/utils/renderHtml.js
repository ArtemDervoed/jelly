...
export default (
  ...
  const html = `
    ...
    <html ${head.htmlAttributes.toString()}>
      <head>
        <meta charset="utf-8">
        <script src="https://res.cloudinary.com/doplillye/raw/upload/v1549283129/morphSVG.js"></script>
        <script src="https://unpkg.com/path2d-polyfill@0.2.1/dist/index.js"></script>
